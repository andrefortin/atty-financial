...
1. Fetch latest documentation the web: 
...
9. Write file to `.pi/agents/code-reviewer.md` (without tools field)
...
9. Write to `.pi/agents/debugger.md`
...
9. Write file to `.pi/agents/code-analyzer.md` with tools field
...
8. Write to `.pi/agents/sql-analyst.md` with model set to haiku
...
9. Write to `.pi/agents/transcriber.md`
10. Confirm creation
...
9. Write to `.pi/agents/script-writer.md` with model set to opus
...
9. Write to `.pi/agents/social-media-strategist.md`
10. Confirm creation
...
9. Write to `.pi/agents/doc-writer.md`
10. Confirm creation
...
9. Write to `.pi/agents/research-synthesizer.md`
