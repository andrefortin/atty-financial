...
function tilldone(
  action: "new-list" | "add" | "toggle" | "remove" | "update" | "list" | "clear",
  text?: string,        // Task text (for add/update), or list title (for new-list)
  texts?: string[],     // Multiple task texts (for batch add)
  description?: string, // List description (for new-list)
  id?: number           // Task ID (for toggle/remove/update)
): void;
